...
["", "../client.dart", , U, {
  "^": "",
  main: [function() {
    var textBox, log, t1, t2, webSocket;
    textBox = document.querySelector("#textentry");
    log = document.querySelector("#log");
    t1 = P.Uri_base();
    t1 = "ws://" + t1.get$host(t1) + ":";
    t2 = P.Uri_base();
    webSocket = W.WebSocket_WebSocket(t1 + H.S(t2.get$port(t2)) + "/ws", null);
    t2 = H.setRuntimeTypeInfo(new W._EventStream(webSocket, C.EventStreamProvider_open._eventType, false), [null]);
    t2.get$first(t2).then$1(new U.main_closure(textBox, log, webSocket));
  }, "call$0", "main$closure", 0, 0, 1],
  main_closure: {
    "^": "Closure:11;textBox_0,log_1,webSocket_2",
    call$1: function(_) {
      var t1, t2, t3;
      P.print("connected to server!");
      t1 = this.webSocket_2;
      t2 = H.setRuntimeTypeInfo(new W._EventStream(t1, C.EventStreamProvider_message._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.main__closure(this.log_1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = this.textBox_0;
      t3 = J.get$onChange$x(t2);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new U.main__closure0(t2, t1)), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    }
  },
  main__closure: {
    "^": "Closure:11;log_3",
    call$1: function(e) {
      ...
      newMessage = document.createElement("span", null);
      J.set$width$x(newMessage.style, "100%");
      J.set$display$x(newMessage.style, "block");
      newMessage.textContent = t1.get$data(e);
      J.get$children$x(this.log_3).add$1(0, newMessage);
    }
  },
  main__closure0: {
    "^": "Closure:11;textBox_4,webSocket_5",
    call$1: function(e) {
      var t1, t2;
      t1 = this.textBox_4;
      t2 = J.getInterceptor$x(t1);
      this.webSocket_5.send(t2.get$value(t1));
      t2.set$value(t1, "");
    }
  }
},
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure(textBox_0, log_1, webSocket_2) {
    this.textBox_0 = textBox_0;
    this.log_1 = log_1;
  ...
  function main__closure0(textBox_4, webSocket_5) {
    this.textBox_4 = textBox_4;
    this.webSocket_5 = webSocket_5;
  }
